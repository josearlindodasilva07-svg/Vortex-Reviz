...
lplayer.Chatted:Connect(function(msg)
    ...
    if string.sub(msg, 1, 10) == (prefix.."rmeshhats") or string.sub(msg, 1, 10) == (prefix.."blockhats") then
        for i,v in pairs(lplayer.Character:GetChildren()) do
            if (v:IsA("Accessory")) or (v:IsA("Hat")) then
                v.Handle.Mesh:Destroy()
            end
    ...
    if string.sub(msg, 1, 10) == (prefix.."rmeshtool") or string.sub(msg, 1, 10) == (prefix.."blocktool") then
        for i,v in pairs(lplayer.Character:GetChildren()) do
            if (v:IsA("Tool")) then
                v.Handle.Mesh:Destroy()
            end
    ...
    if string.sub(msg, 1, 7) == (prefix.."unstate") then
        changingstate = false
    end
end)
...
CMDBAR.FocusLost:connect(function(enterPressed)
    if enterPressed then
        ...
        if string.sub(CMDBAR.Text, 1, 9) == ("invisible") then
            -- Credit to Timeless
            Local = game:GetService('Players').LocalPlayer
            Char = Local.Character
            touched,tpdback = false, false
        ...
        if string.sub(CMDBAR.Text, 1, 9) == ("rmeshhats") or string.sub(CMDBAR.Text, 1, 9) == ("blockhats") then
            for i,v in pairs(lplayer.Character:GetChildren()) do
                if (v:IsA("Accessory")) or (v:IsA("Hat")) then
                    v.Handle.Mesh:Destroy()
                end
        ...
        if string.sub(CMDBAR.Text, 1, 9) == ("rmeshtool") or string.sub(CMDBAR.Text, 1, 9) == ("blocktool") then
            for i,v in pairs(lplayer.Character:GetChildren()) do
                if (v:IsA("Tool")) then
                    v.Handle.Mesh:Destroy()
                end
        ...
        if string.sub(CMDBAR.Text, 1, 8) == ("clickdel") then
            clickdel = true
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Click Delete";
        ...
        if string.sub(CMDBAR.Text, 1, 10) == ("noclickdel") then
            clickdel = false
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Click Delete";
                Text = "Click delete has been disabled.";
        ...
        if string.sub(CMDBAR.Text, 1, 8) == ("unstate") then
            changingstate = false
        end
        ...
        if string.sub(CMDBAR.Text, 1, 7) == ("prefix ") then
            prefix = (string.sub(CMDBAR.Text, 8, 8))
            wait(0.1)
            change()
            wait(0.1)
            game:GetService("StarterGui"):SetCore("SendNotification", {
